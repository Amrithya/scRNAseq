...
NCCL_DEBUG=INFO CUDA_VISIBLE_DEVICES=0,1,2,3 CUDA_LAUNCH_BLOCKING=1 poetry run torchrun --nproc_per_node=4 --nnodes=1 --node_rank=0 besteffort_finetuning.py \
