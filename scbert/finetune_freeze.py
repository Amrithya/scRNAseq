...
parser.add_argument("--model_name", type=str, default='only_classifer')
...
np.save(os.path.join(ckpt_dir, 'only_classifer_embeddings.npy'), all_embeddings)
np.save(os.path.join(ckpt_dir, 'only_classifer_labels.npy'), all_labels)
